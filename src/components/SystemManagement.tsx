...
export default function SystemManagement() {
  ...
  const allSubmenuItems = [
    { label: '字典管理', icon: BookOpen, key: 'dictionary', menuKey: 'system.dictionary' },
    { label: '菜单管理', icon: MenuIcon, key: 'menu', menuKey: 'system.menu' },
  ];

  const submenuItems = allSubmenuItems.filter(item => item.menuKey === 'system.menu' || isVisible(item.menuKey));
